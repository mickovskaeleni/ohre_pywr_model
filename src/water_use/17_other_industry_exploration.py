...
# ======================================================
# OTHER INDUSTRY FILTER
# ======================================================

other_industry = pilot_desc[
    pilot_desc["OD_OST"].fillna(0) > 0
].copy()
...
print(
    f"OD_OST abstractions: {len(other_industry):,}"
)

print(
    f"Unique IDs: {other_industry['ID'].nunique():,}"
)

if len(other_industry) == 0:
    print(
        "\nNo OD_OST abstractions found."
    )
    raise SystemExit()

# ======================================================
# JOIN TO MVM TIMESERIES
# ======================================================
...
top_users.to_csv(
    OUTPUT_DIR /
    "other_industry_top_users.csv",
    index=False
)

top_municipalities.to_csv(
    OUTPUT_DIR /
    "other_industry_top_municipalities.csv",
    index=False
)

yearly.to_csv(
    OUTPUT_DIR /
    "other_industry_yearly_trend.csv",
    index=False
)
