...
print(
    "Irrigation supply IDs:",
    len(irrigation_supply_ids)
)
...
irrigation_ts["MVM"] = pd.to_numeric(
    irrigation_ts["MVM"],
    errors="coerce"
)

irrigation_ts = irrigation_ts[
    irrigation_ts["MVM"].notna()
]
...
monthly_path = (
    OUTPUT_DIR /
    "irrigation_monthly_mvm.csv"
)

yearly_path = (
    OUTPUT_DIR /
    "irrigation_yearly_mvm.csv"
)
